<template>
  <div id="app">
    <main class="flex flex-col items-center">
      <div
        id="plant"
        class="bg-gray-800 text-gray-500 w-2/5 rounded-lg mt-4"
      ...
      <div id="new-plant-container" class="flex flex-col w-2/5 mt-4">
        <div
          id="new-plant-edit"
        ...
        >
          <div id="new-plant-edit-name" class="m-4 flex flex-row items-center">
            <div class="w-1/6">
              <label for="name-input" class="text-gray-400">Name</label>
            </div>
            <div class="w-full">
              <input
                type="text"
          ...
          <div id="new-plant-edit-species" class="m-4 flex flex-row items-center">
            <div class="w-1/6">
              <label for="species-input" class="text-gray-400">Species</label>
            </div>
            <div class="w-full">
              <input
                type="text"
